...
class Unet():
    ...
    def initial_model(self, img_shape, num_class, metrics):
        concat_axis = 3
        ...
        upsampling1 = Conv2DTranspose(512, (2, 2), strides=(2, 2), padding='valid')(conv5_2)
        ch, cw = self.crop_feature_map(conv4_2, upsampling1)
        crop_conv4_2 = Cropping2D(cropping=(ch, cw))(conv4_2)
        up6 = concatenate([upsampling1, crop_conv4_2], axis=concat_axis)
        ...
        upsampling2 = Conv2DTranspose(256, (2, 2), strides=(2, 2), padding='valid')(conv6_2)
        ch, cw = self.crop_feature_map(conv3_2, upsampling2)
        crop_conv3_2 = Cropping2D(cropping=(ch, cw))(conv3_2)
        up7 = concatenate([upsampling2, crop_conv3_2], axis=concat_axis)
        ...
        upsampling3 = Conv2DTranspose(128, (2, 2), strides=(2, 2), padding='valid')(conv7_2)
        ch, cw = self.crop_feature_map(conv2_2, upsampling3)
        crop_conv2_2 = Cropping2D(cropping=(ch, cw))(conv2_2)
        up8 = concatenate([upsampling3, crop_conv2_2], axis=concat_axis)
        ...
        upsampling4 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding='valid')(conv8_2)
        ch, cw = self.crop_feature_map(conv1_2, upsampling4)
        crop_conv1_2 = Cropping2D(cropping=(ch, cw))(conv1_2)
        up9 = concatenate([upsampling4, crop_conv1_2], axis=concat_axis)
